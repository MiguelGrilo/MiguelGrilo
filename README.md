...
**Academic:** BSc in Artificial Intelligence and Data Science | University of Évora (2023 - 2026)
...
### Software Developer Intern — IMPACT Commerce (Feb 2026 - Jun 2026)
*   **Pipeline Engineering:** Designed and architected an intelligent hybrid search assistant pipeline for an E-commerce platform targeting the Portuguese market.
*   **Backend Architecture:** Engineered a robust three-layer backend system architecture utilizing **.NET 8** and **C#**.
*   **Advanced Retrieval:** Implemented an advanced retrieval system in **Azure AI Search** by combining vector search with lexical search.
*   **Search Optimization:** Developed optimization strategies using OData filters and embeddings to enhance product catalog retrieval relevancy.

### IntelliScan — AI Cup 2025 (TE Connectivity)
*   **Industrial AI Solution:** Developed an AI-driven tool designed to solve real-world industrial challenges.
*   **Computer Vision Pipeline:** Created an end-to-end framework for 2D defect detection and STL volumetric analysis leveraging **Ultralytics (YOLO)** and **Open3D** libraries.
*   **Interactive Analytics:** Integrated final models into an interactive **Streamlit** dashboard and handled complex data processing via **NumPy** and **Matplotlib**.
